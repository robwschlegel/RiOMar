...
# =============================================================================
#### Dynamic threshold — main results
# =============================================================================

run_full_analysis(
  plume_dir  = "output/panache/dynamic",
  stats_dir  = "output/STATS",
  fig_path   = "figures/Figure_10.png"
)


# =============================================================================
#### Static threshold — supplementary
# =============================================================================

run_full_analysis(
  plume_dir  = "output/panache/static",
  stats_dir  = "output/STATS/static",
  fig_path   = "figures/supplementary/Figure_10_static.png"
)


message("code/6_driver_interactions.R complete.")
